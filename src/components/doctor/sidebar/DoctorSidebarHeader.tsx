    ...
    return (
        <>
            <div className="flex flex-col gap-4 p-4 border-b border-slate-200 bg-white">
                ...
                <button
                    className="w-full py-3 px-4 rounded-xl bg-blue-600 text-white font-medium text-sm hover:bg-blue-700 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-200"
                >
                    <PlusCircle size={18} />
